        ...
        <TabControl x:Name="TabControl" Margin="-3,-1,3,1" Background="#FFACACAC" BorderBrush="#FF610536" >
            ...
            <TabItem Header="Drivers" Height="20" MinWidth="100">
                <Grid>
                    ...
                    <CheckBox x:Name="DriverDismRecurseCheckBox" Content="Use Fast DISM Recursive Injection" HorizontalAlignment="Left" Margin="26,100,0,0" VerticalAlignment="Top" IsEnabled="False"/>
